...
buildableAttributes_t bg_buildableList[ ] =
{
  ...
  },//ROTAX
  {
    ...
    { "models/buildables/plank/plank.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -40, -40, -4 },     //vec3_t    mins;
    { 40, 40, 2 },        //vec3_t    maxs;
    0.0f,                  //float     zOffset;
  ...
  },
  {
    ...
    { "models/buildables/crate/crate.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -21, -21, -21 },     //vec3_t    mins;
    { 21, 21, 19 },        //vec3_t    maxs;
    0.0f,                  //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/pillar/pillar.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -14, -14, -15 },     //vec3_t    mins;
    { 14, 14, 44 },        //vec3_t    maxs;
    0.0f,                  //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/brickh/brickh.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -15, -15, -9 },     //vec3_t    mins;
    { 15, 15, 7 },        //vec3_t    maxs;
    0.0f,                  //float     zOffset;
  ...
  },
  {
    ...
    { "models/buildables/container/container.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -40, -40, -10 },     //vec3_t    mins;
    { 40, 40, 70 },        //vec3_t    maxs;
    0.0f,                  //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/flagh/flagh.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -15, -15, -10 },     //vec3_t    mins;
    { 15, 15, 35 },        //vec3_t    maxs;
    0.0f,                  //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/bricka/bricka.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -15, -15, -9 },     //vec3_t    mins;
    { 15, 15, 7 },        //vec3_t    maxs;
    0.0f,                //float     zOffset;
  ...
  },
  {
    ...
    { "models/buildables/bridge/bridge.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -40, -40, -4 },     //vec3_t    mins;
    { 40, 40, 6 },        //vec3_t    maxs;
    0.0f,                //float     zOffset;
  ...
  },
  {
    ...
    { "models/buildables/bamboo/bamboo.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
//    { -4, -4, -17 },     //vec3_t    mins;
//    { 4, 4, 58 },        //vec3_t    maxs;
    { -4, -4, -37 },     //vec3_t    mins;
  ...
  },
  {
    ...
    { "models/buildables/rock/rock.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
//    { -30, -30, -11 },     //vec3_t    mins;
//    { 30, 30, 42 },        //vec3_t    maxs;
    { -30, -30, -26 },     //vec3_t    mins;
    { 30, 30, 26 },        //vec3_t    maxs;
    -15.0f,                //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/bush/bush.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
//    { -20, -20, -16 },     //vec3_t    mins;
//    { 20, 20, -5 },        //vec3_t    maxs;
    { -20, -20, -10 },     //vec3_t    mins;
    { 20, 20, 5 },        //vec3_t    maxs;
    5.0f,                //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/flower/flower.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
//    { -5, -5, -15 },     //vec3_t    mins;
//    { 5, 5, -5 },        //vec3_t    maxs;
    { -5, -5, -5 },     //vec3_t    mins;
  ...
  },
  {
    ...
    { "models/buildables/grass/grass.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
//    { -5, -5, -18 },     //vec3_t    mins;
//    { 5, 5, -10 },        //vec3_t    maxs;
    { -7, -7, -7 },     //vec3_t    mins;
  ...
  },
  {
    ...
    { "models/buildables/tree/tree.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
//    { -5, -5, -11 },     //vec3_t    mins;
//    { 5, 5, -3 },        //vec3_t    maxs;
    { -34, -34, -3 },     //vec3_t    mins;
    { 34, 34, 230 },        //vec3_t    maxs;
    0.0f,                //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/flaga/flaga.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
//    { -15, -15, -10 },     //vec3_t    mins;
//    { 15, 15, 35 },        //vec3_t    maxs;
    { -15, -15, -22 },     //vec3_t    mins;
    { 15, 15, 22 },        //vec3_t    maxs;
    -10.0f,                //float     zOffset;
    TR_GRAVITY,            //trType_t  traj;
    0.0,                   //float     bounce;
  ...
  },
  {
    ...
    { "models/buildables/jumppad/jumppad.md3", 0, 0, 0 },
    1.0f,                  //float     modelScale;
    { -23, -20, -5 },     //vec3_t    mins;
    { 23, 20, 5 },        //vec3_t    maxs;
    0.0f,                //float     zOffset;
...
{
  {
    ...
    0.0f,                                           //float   zOffset
    0.f,                                            //float   spriteOffset;//ROTAXfun
  ...
  },
  {
    ...
    { 32, 32, 4 },                                  //vec3_t  deadmaxs;
    0.0f,                                           //float   zOffset
    32.f,                                            //float   spriteOffset;//ROTAXfun
  ...
  },
  {
    ...
    { 15, 15, 4 },                                  //vec3_t  deadmaxs;
    0.0f,                                           //float   zOffset
    88.f,                                           //float   spriteOffset;//ROTAXfun
  ...
  },
  {
    ...
    { 15, 15, 4 },                                  //vec3_t  deadmaxs;
    0.0f,                                           //float   zOffset
    16.f,                                           //float   spriteOffset;//ROTAXfun
...
weaponAttributes_t bg_weapons[ ] =
{
  ...
  },
  {
    ...
    PRIFLE_REPEAT,        //int       repeatRate2;//ROTAXfun
    PRIFLE_REPEAT,        //int       repeatRate3;//ROTAXfun
    PRIFLE_RELOAD,        //int       reloadTime;
    PRIFLE_K_SCALE,       //float     knockbackScale;
    qtrue,               //qboolean  hasAltMode;//ROTAXfun
    qtrue,               //qboolean  hasThirdMode;//ROTAXfun
    qfalse,               //qboolean  canZoom;
    90.0f,                //float     zoomFov;
    qtrue,                //qboolean  purchasable;
    qtrue,                //qboolean  longRanged;
