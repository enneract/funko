...
qboolean  ConsoleCommand( void )
{
  ...
  if( !Q_stricmp( cmd, "armageddon" ) )
  {
   ...
   //ROTAXfun
  if( !Q_stricmp( cmd, "delay" ) )
  {
    trap_Cvar_Set( "g_suddenDeathTime", va("%i", (g_suddenDeathTime.integer + 10)) );
    trap_SendServerCommand( -1, va("cp \"Sudden Death was delayed by 10 minutes\n\""  ) );
  }
